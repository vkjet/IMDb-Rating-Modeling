...
aML_movies <- h2o.automl(6:32, 33, train1, max_runtime_secs = 120)
...
*Gradient Boosting Machine* (or `GBM`) model returns the most impressive results on training dataset with 0 errors. On the test data it has an error in around 40% of cases. It seems like we deal with overfitting problem here. Further tests needed.

Let's build a standalone GBM model
```{r}
gbm <- h2o.gbm(6:32, 1, training_frame = train1)
